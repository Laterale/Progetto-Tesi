...
export const LagoonMapContent = () => {
  ...
  [
    { src: "/assets/algae.png", alt: "algae 1", position: "right-60 bottom-72", size: "h-[25px] w-[60px]"},
    { src: "/assets/algae.png", alt: "algae 2", position: "right-56 bottom-96", size: "h-[30px] w-[80px]"},
    { src: "/assets/algae.png", alt: "algae 3", position: "right-40 bottom-80", size: "h-[25px] w-[40px]"},
    { src: "/assets/algae.png", alt: "algae 4", position: "right-44 bottom-64", size: "h-[40px] w-[60px]"},
    { src: "/assets/algae.png", alt: "algae 5", position: "right-72 bottom-80", size: "h-[40px] w-[70px]"},
    { src: "/assets/algae.png", alt: "algae 6", position: "right-44 absolute-center-y", size: "h-[30px] w-[50px]"},
    { src: "/assets/dead-fish.png", alt: "dead fish 1", position: "left-36 bottom-56", size: "h-[40px] w-[80px]" },
    { src: "/assets/dead-fish.png", alt: "dead fish 2", position: "left-52 bottom-96", size: "h-[30px] w-[80px]" },
